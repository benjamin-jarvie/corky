...
C = [
 ...
 ("corky/main.py", "ImageQrSource.images", 3,
  "the abstract marker, raise NotImplementedError"),
 ("corky/main.py", "CameraQrSource.images", 2,
  "picamera2 open, frame loop, teardown"),
 ("corky/main.py", "DevQrSource.strings", 1,
  "dev paths with neither --qr-key nor --qr-psbt"),
 ("corky/main.py", "DevQrSource.scan_psbt_frames", 1,
