...
SUITES_FAST="tests/test_integrity.py shim/test_shim.py tests/test_codex32.py tests/test_seedqr.py tests/test_qrchannel.py tests/test_filechannel.py tests/test_property.py"
SUITES_NODE="tests/test_addresses.py tests/e2e_regtest.py tests/e2e_filechannel.py tests/e2e_session.py tests/test_matrix.py tests/test_adversarial.py"
FAILED=0
