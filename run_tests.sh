...
SUITES_FAST="tests/test_integrity.py tests/test_readme_claims.py shim/test_shim.py tests/test_codex32.py tests/test_seedqr.py tests/test_qrchannel.py tests/test_filechannel.py tests/test_property.py tests/test_screen_fit.py tests/test_ui_cost.py"
