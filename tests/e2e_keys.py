...
def main():
    ...
    try:
        ...
        # live lookup.
        # The menu carries a Multisig row under the four policies, so
        # the expected render has to be given what the device gives it.
        assert _has(fr5, _render(
            scr.script_menu, signer.EXPORT_ORDER, 0, multisig=True)), \
