...
**Layer 2 sees secrets, computes nothing with them. 2534 lines.**
...
**Total functional code: 2,802 lines** (5,951 with blanks/comments).
**Test code: 7,332 lines**, none of which ships.
