...
**Layer 2 sees secrets, computes nothing with them. 2113 lines.**
...
**Total functional code: 2,371 lines** (4,661 with blanks/comments).
**Test code: 6,195 lines**, none of which ships.
