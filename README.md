...
**Layer 2 sees secrets, computes nothing with them. 2592 lines.**
...
**Total functional code: 2,860 lines** (6,229 with blanks/comments).
**Test code: 7,733 lines**, none of which ships.
