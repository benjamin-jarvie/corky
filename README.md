...
**Layer 2 — sees secrets, computes nothing with them. 947 lines.**
...
[`corky/main.py`](corky/main.py) (525) ·
[`corky/screens.py`](corky/screens.py) (360) ·
...
**Total functional code: 1,547 lines** (2,230 with blanks/comments).
A bug in layers 2–3 can annoy you; it cannot leak what it never
algebraically touches.

**Test code: 2,649 lines — none of it ships on the device.**
