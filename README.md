...
**Layer 2 sees secrets, computes nothing with them. 2110 lines.**
...
**Total functional code: 2,368 lines** (4,574 with blanks/comments).
**Test code: 5,784 lines**, none of which ships.
