...
**Layer 2 sees secrets, computes nothing with them. 2118 lines.**
...
**Total functional code: 2,376 lines** (4,739 with blanks/comments).
**Test code: 6,295 lines**, none of which ships.
