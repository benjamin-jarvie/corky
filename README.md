...
**Layer 2 sees secrets, computes nothing with them. 2104 lines.**
...
**Total functional code: 2,362 lines** (4,547 with blanks/comments).
**Test code: 5,737 lines**, none of which ships.
