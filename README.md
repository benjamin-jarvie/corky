...
**Layer 2 sees secrets, computes nothing with them. 2126 lines.**
...
**Total functional code: 2,401 lines** (4,848 with blanks/comments).
**Test code: 6,428 lines**, none of which ships.
